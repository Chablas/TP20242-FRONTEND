...
export default function DashboardProveedoresFila(props) {
    ...
    return (
        <tr className="border-b border-b-[#394050]">
            ...
            <td className="text-white font-light text-center py-2 px-4">0132547698</td>
            <td className="text-white font-light text-center py-2 px-4">AV.BENAVIDES 5440</td>
            <td className="text-white font-light text-center py-2 px-4">maria.chiok@urp.edu.pe</td>
