...
<div >
    <a className="group relative inline-flex border border-[#815183] focus:outline-none w-full sm:w-auto" href="/categorias">
        <span className=" w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-white text-center font-bold uppercase bg-[#815183] ring-1 ring-bg-[#815183] ring-offset-1 ring-offset-[#815183]  transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
        Mira colección
    </span>
    </a>
